...
1. [UTM Naming Convention](#1-utm-naming-convention)
   - [UTM Parameter Structure](#utm-parameter-structure)
   - [Platform Values](#platform-values-utm_source)
   - [Medium Values](#medium-values-utm_medium)
   - [Campaign Values](#campaign-values-utm_campaign)
   - [Content Values](#content-values-utm_content)
2. [Budget Allocation](#2-budget-allocation)
   - [Total Budget: EUR 1,500 / 30 Days](#total-budget-eur-1500--30-days)
   - [Budget Rationale](#budget-rationale-based-on-historical-performance--available-assets)
3. [Google Search Campaign](#3-google-search-campaign)
   - [Ad Group 1: Brand Terms](#ad-group-1-brand-terms)
   - [Ad Group 2: Generic Energy Terms](#ad-group-2-generic-energy-terms)
   - [Sitelink Extensions](#sitelink-extensions-both-ad-groups)
4. [Google Display Campaigns](#4-google-display-campaigns)
   - [Campaign Structure Overview](#campaign-structure-overview)
   - [Campaign A: Display Targeting Grünstrom (Classic HTML5)](#campaign-a-display-targeting-grünstrom-classic-html5)
   - [Campaign A2: Display Targeting Grünstrom (Responsive)](#campaign-a2-display-targeting-grünstrom-responsive)
   - [Campaign B: Display Targeting Genossenschaft (Classic HTML5)](#campaign-b-display-targeting-genossenschaft-classic-html5)
   - [Campaign B2: Display Targeting Genossenschaft (Responsive)](#campaign-b2-display-targeting-genossenschaft-responsive)
   - [Campaign C: Display Retargeting (Classic HTML5)](#campaign-c-display-retargeting-classic-html5)
5. [Google YouTube Campaigns](#5-google-youtube-campaigns)
   - [Recommendation on YouTube](#recommendation-on-youtube)
   - [Campaign: YouTube Targeting Grünstrom](#campaign-youtube-targeting-grünstrom)
6. [Meta Facebook Campaigns](#6-meta-facebook-campaigns)
   - [Campaign A: Targeting Grünstrom](#campaign-a-targeting-grünstrom)
   - [Campaign B: Targeting Genossenschaft](#campaign-b-targeting-genossenschaft)
   - [Campaign C: Targeting Carousels](#campaign-c-targeting-carousels)
7. [Meta Instagram Campaigns](#7-meta-instagram-campaigns)
   - [Campaign A: Targeting Grünstrom (Instagram)](#campaign-a-targeting-grünstrom-instagram)
...
9. [Landing Pages & URLs](#9-landing-pages--urls)
   - [Primary Landing Pages](#primary-landing-pages)
...
11. [Asset Mapping by Campaign](#11-asset-mapping-by-campaign)
    - [Google Display Campaigns](#google-display-campaigns)
    - [Complete HTML5 Banner File List](#complete-html5-banner-file-list)
    - [Responsive Display Ad Image Sources](#responsive-display-ad-image-sources)
    - [Google YouTube Campaign](#google-youtube-campaign)
    - [Meta Campaigns](#meta-campaigns)
    - [Additional Available Assets](#additional-available-assets-not-currently-mapped)
12. [Looker Studio Requirements](#12-looker-studio-requirements)
    - [Data Sources to Connect](#data-sources-to-connect)
    - [Required Dimensions for Consistency](#required-dimensions-for-consistency)
    - [Recommended Report Pages](#recommended-report-pages)
...
14. [Quick Reference All Campaign Names](#14-quick-reference-all-campaign-names)
    ...
    - [Meta Campaigns](#meta-campaigns-1)
15. [Key Messages Reference](#15-key-messages-reference)
    - [Testimonial Priority for Bürger Target Group](#testimonial-priority-for-bürger-target-group)
    - [Landing Page URLs](#landing-page-urls)
    - [Key Branded Messages](#key-branded-messages-must-use)
    - [Testimonial Slogans](#testimonial-slogans)
...
| Setting | Value |
|---------|-------|
| Campaign Name | Regios - Meta - Retargeting - Genossenschaft |
| Objective | Leads |
| Budget | €5.00/day (€150/month) |
| Schedule | Ongoing |
...
**📈 Continuous Optimization Note:**
The retargeting campaigns below provide multiple creative approaches (video cards, long-form videos, image carousels) across different personas and themes. As data accumulates over time, monitor performance to identify:
- Which personas resonate with which audience segments
- Which formats drive best engagement
- Which themes (interviewee-specific vs. Grünstrom vs. Genossenschaft values) convert best

Use these learnings to optimize budget allocation, pause underperforming ads, and refine audience targeting. The more data collected, the better we can tailor retargeting for maximum relevance and ROI.

---

**📱 Stories/Reels Retargeting (9:16) - Future Phase:**
Stories and Reels retargeting with 9:16 vertical videos will be added in a later phase after analyzing Video Card (1:1) performance. This will require:
- Building sequential audiences (e.g., user saw "Sarah - Vorstellung" → next show "Sarah - Warum Regios")
- Creating individual video ads for each topic per person
- Proper audience segmentation based on video view data

For now, we focus on Video Cards (Feed), Long Videos, and Image Carousels.
...
**Asset Path:** `Testimonial - Sarah/Sarah 1_1 mit Abbinder/`

| Card | Topic | Video File | Headline | Description | utm_term |
|------|-------|------------|----------|-------------|----------|
| 1 | Vorstellung | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Vorstellung.mp4` | Sarah stellt sich vor | Bürgerin aus dem Mühlviertel | `vorstellung` |
| 2 | Warum Regios | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Warum Regios.mp4` | Warum Regios? | Sarahs Überzeugung | `warum_regios` |
| 3 | Wie auf Regios gekommen | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Wie auf Regios gekommen.mp4` | Wie ich zu Regios kam | Der erste Kontakt | `wie_gekommen` |
| 4 | Zweifel | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Zweifel.mp4` | Hatte ich Zweifel? | Ehrliche Gedanken | `zweifel` |
| 5 | Was ist wichtig | `Testimonial - Sarah - 1-1 - Short  - mit Abbinder- ws ist wichtig.mp4` | Was mir wichtig ist | Meine Werte | `was_wichtig` |
| 6 | Gemeinsam Stark | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Gemeinsam Stark.mp4` | Gemeinsam stark | Die Kraft der Gemeinschaft | `gemeinsam_stark` |
| 7 | Wertschöpfung in der Region | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Wertschöpfung in der Region.mp4` | Regionale Wertschöpfung | Geld bleibt hier | `wertschoepfung` |
| 8 | Persönlicher Ansprechpartner | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Persönlicher Ansprechpartner.mp4` | Persönlicher Kontakt | Menschen statt Hotlines | `ansprechpartner` |
| 9 | Wirkungskraft | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Wirkungskraft.mp4` | Was Regios bewegt | Sichtbare Veränderung | `wirkungskraft` |
| 10 | Produkte | `Testimonial - Sarah - 1-1 - Short - mit Abbinder - Produkte.mp4` | Verständliche Produkte | Klare Angebote | `produkte` |
...
#### Carousel 2: Peter (Grundbesitzer) - 7 Cards

**Asset Path:** `Testimonial - Peter/Peter 1_1 mit Abbinder/`

| Card | Topic | Video File | Headline | Description | utm_term |
|------|-------|------------|----------|-------------|----------|
| 1 | Vorstellung | `Testimonial - Peter - 1-1 - Short - mit Abbinder - Vorstellung.mp4` | Peter stellt sich vor | Grundbesitzer aus dem Mühlviertel | `vorstellung` |
| 2 | Regionale Energieversorgung | `Testimonial - Peter - 1-1 - Short - mit Abbinder - regionale Energieversorgung.mp4` | Regionale Energie | Versorgung aus der Region | `energieversorgung` |
| 3 | Selbstversorger | `Testimonial - Peter - 1-1 - Short - mit Abbinder - Selbstversorger.mp4` | Selbstversorger werden | Unabhängigkeit am Hof | `selbstversorger` |
| 4 | Weiteres Standbein | `Testimonial - Peter - 1-1 - Short - mit Abbinder - weiteres Standbein.mp4` | Weiteres Standbein | Zusätzliches Einkommen | `standbein` |
| 5 | Wie kennengelernt | `Testimonial - Peter - 1-1 - Short - mit Abbinder - wie kennengelernt.mp4` | Wie ich Regios fand | Der erste Kontakt | `kennengelernt` |
| 6 | Doppelnutzung | `Testimonial - Peter - 1-1 - Short - mit Abbinder - Doppelnutzung.mp4` | Doppelnutzung | Flächen sinnvoll nutzen | `doppelnutzung` |
| 7 | Risiko oder Chance | `Testimonial - Peter - 1-1 - Short - mit Abbinder - Risiko oder Chance.mp4` | Risiko oder Chance? | Peters Einschätzung | `risiko_chance` |
...
#### Carousel 3: Susanne (Gemeinde) - 10 Cards

**Asset Path:** `Testimonial - Susanne/Susanne 1_1 mit Abbinder/`

| Card | Topic | Video File | Headline | Description | utm_term |
|------|-------|------------|----------|-------------|----------|
| 1 | Vorstellung | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Vorstellung.mp4` | Susanne stellt sich vor | Gemeindevertreterin | `vorstellung` |
| 2 | Warum Regios | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Warum Regios.mp4` | Warum Regios? | Die Gemeinde-Perspektive | `warum_regios` |
| 3 | Gemeinsames Eigentum | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - gemeinsames Eigentum.mp4` | Gemeinsames Eigentum | Wir alle sind Besitzer | `eigentum` |
| 4 | Erreichbarkeit | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Erreichbarkeit.mp4` | Immer erreichbar | Persönlicher Kontakt | `erreichbarkeit` |
| 5 | USP | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - USP.mp4` | Was uns besonders macht | Unser Alleinstellungsmerkmal | `usp` |
| 6 | Regios wichtiger Partner | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Regios wichtiger Partner für Energie.mp4` | Wichtiger Partner | Energie für die Gemeinde | `partner` |
| 7 | Vertrauen | `Testimonial - Susanne - 1-1 - Short  - mit Abbinder - Vertrauen.mp4` | Vertrauen | Verlässliche Partnerschaft | `vertrauen` |
| 8 | Sichtbare Veränderung | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Sichtbare Veränderung.mp4` | Sichtbare Veränderung | Was sich verändert hat | `veraenderung` |
| 9 | Risiko oder Chance | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Riskio oder Chance.mp4` | Risiko oder Chance? | Susannes Einschätzung | `risiko_chance` |
| 10 | Danke | `Testimonial - Susanne - 1-1 - Short - mit Abbinder - Danke.mp4` | Danke! | Ein Wort zum Schluss | `danke` |
...
#### Carousel 4: Norbert (Bürger) - 10 Cards

**Asset Path:** `Testimonial - Norbert/Norbert 1_1 mit Abbinder/`

| Card | Topic | Video File | Headline | Description | utm_term |
|------|-------|------------|----------|-------------|----------|
| 1 | Vorstellung | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Vorstellung.mp4` | Norbert stellt sich vor | Bürger aus dem Mühlviertel | `vorstellung` |
| 2 | Sicherheit | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Sicherheit.mp4` | Sicherheit | Was mir Sicherheit gibt | `sicherheit` |
| 3 | Vertrauen | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Vertrauen.mp4` | Vertrauen | Warum ich vertraue | `vertrauen` |
| 4 | Transparenz | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Transparenz.mp4` | Transparenz | Offene Kommunikation | `transparenz` |
| 5 | Nachhaltigkeit | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Nachhaltigkeit.mp4` | Nachhaltigkeit | Für die nächste Generation | `nachhaltigkeit` |
| 6 | Banken als Partner | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Banken als Partner.mp4` | Banken als Partner | Starke Unterstützung | `banken_partner` |
| 7 | Wirkungskraft | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Wirkungskraft.mp4` | Was Regios bewegt | Sichtbare Wirkung | `wirkungskraft` |
| 8 | Erreichbarkeit | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Erreichbarkeit.mp4` | Immer erreichbar | Persönlicher Kontakt | `erreichbarkeit` |
| 9 | Risiko | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Risiko.mp4` | Risiko? | Ehrliche Einschätzung | `risiko` |
| 10 | Risiko oder Chance | `Testimonial - Norbert - 1-1 - Short - mit Abbinder - Risiko oder Chance.mp4` | Risiko oder Chance? | Norberts Fazit | `risiko_chance` |
...
#### Carousel 5: Christian (Bank) - 10 Cards

**Asset Path:** `Testimonial - Christian/1_1/`

| Card | Topic | Video File | Headline | Description | utm_term |
|------|-------|------------|----------|-------------|----------|
| 1 | Vorstellung | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Vorstellung.mp4` | Christian stellt sich vor | Bankpartner im Mühlviertel | `vorstellung` |
| 2 | Bank als Entwicklungspartner | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Bank als Entwicklungspartner.mp4` | Entwicklungspartner | Banken unterstützen | `entwicklungspartner` |
| 3 | Vertrauen | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Vertrauen.mp4` | Vertrauen | Basis der Zusammenarbeit | `vertrauen` |
| 4 | Transparenz | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Transparenz.mp4` | Transparenz | Offene Bücher | `transparenz` |
| 5 | Sicherheit Stabilität | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Sicherheit Stabilität.mp4` | Sicherheit & Stabilität | Solide Grundlage | `sicherheit_stabilitaet` |
| 6 | Nachhaltigkeit | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Nachhaltigkeit.mp4` | Nachhaltigkeit | Langfristig denken | `nachhaltigkeit` |
| 7 | Prinzip Genossenschaft | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Prinzip Genossenschaft.mp4` | Prinzip Genossenschaft | Gemeinsam stärker | `prinzip` |
| 8 | Langfristigkeit | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Langfristigkeit.mp4` | Langfristigkeit | Beständige Partnerschaft | `langfristigkeit` |
| 9 | Wirkungskraft | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Wirkungskraft.mp4` | Was Regios bewegt | Sichtbare Wirkung | `wirkungskraft` |
| 10 | Regios als langfristiges Modell | `Testimonial - Christian - 1-1 - Short - mit Abbinder - Regios als langfristiges Modell.mp4` | Langfristiges Modell | Zukunftssicher | `langfristiges_modell` |
...
#### Carousel 6: Klaus (Unternehmer) - 10 Cards

**Asset Path:** `Testimonial - Klaus/Klaus 1_1 mit Abbinder/`

| Card | Topic | Video File | Headline | Description | utm_term |
|------|-------|------------|----------|-------------|----------|
| 1 | Vorstellung | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Vorstellung.mp4` | Klaus stellt sich vor | Unternehmer im Mühlviertel | `vorstellung` |
| 2 | Energiekosten | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Energiekosten.mp4` | Energiekosten | Kosten im Griff | `energiekosten` |
| 3 | Verantwortung der Region | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Verantwortung der Region.mp4` | Regionale Verantwortung | Für unsere Heimat | `verantwortung` |
| 4 | Unabhängigkeit Selbstgestaltung | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Unabhängigkeit Selbstgestaltung.mp4` | Unabhängigkeit | Selbst gestalten | `unabhaengigkeit` |
| 5 | Regionale Wertschöpfung | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - regionale Wertschöpfung.mp4` | Regionale Wertschöpfung | Geld bleibt hier | `wertschoepfung` |
| 6 | Kompetenz Regios | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Kompetenz Regios.mp4` | Kompetenz | Fachleute vor Ort | `kompetenz` |
| 7 | Vorbild Regios | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Vorbild Regios.mp4` | Vorbild Regios | Beispiel für andere | `vorbild` |
| 8 | Transparenz | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Transparenz.mp4` | Transparenz | Klare Kommunikation | `transparenz` |
| 9 | Stabile Preisentwicklung | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - stabile Preisentwicklung.mp4` | Stabile Preise | Planbare Kosten | `preisentwicklung` |
| 10 | Vertrauen | `Testimonial - Klaus - 1-1 - Short - mit Abbinder - Vertrauen.mp4` | Vertrauen | Zuverlässiger Partner | `vertrauen` |
...
| Primary Text | 👩 Sarah aus dem Mühlviertel: Das ganze Interview<br><br>UNSERE ENERGIE REGIOS<br><br>Mia san ned Deppad! Erfahre die komplette Geschichte. |
| CTA | Learn More |
| Website URL | `https://www.regios.at/buerger?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_testimonial&utm_content=sarah_long` |
...
| Primary Text | 👨‍🌾 Peter, Grundbesitzer aus dem Mühlviertel: Das ganze Interview<br><br>UNSERE ENERGIE REGIOS<br><br>Zeigen wir was unser kleines Bauernland drauf hat! |
| CTA | Learn More |
| Website URL | `https://www.regios.at/grundbesitzer?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_testimonial&utm_content=peter_long` |
...
| Primary Text | 👩‍💼 Susanne, Gemeindevertreterin: Das ganze Interview<br><br>UNSERE ENERGIE REGIOS<br><br>Über 18 Gemeinden sind schon dabei! |
| CTA | Learn More |
| Website URL | `https://www.regios.at/gemeinde?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_testimonial&utm_content=susanne_long` |
...
| Primary Text | 👨‍💼 Klaus, Unternehmer aus dem Mühlviertel: Das ganze Interview<br><br>UNSERE ENERGIE REGIOS<br><br>Regionale Wertschöpfung! |
| CTA | Learn More |
| Website URL | `https://www.regios.at/unternehmer?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_testimonial&utm_content=klaus_long` |
...
#### Carousel 1: Sarah Images

| Field | Content |
|-------|---------|
| Images | Sarah testimonial images (1080x1080) |
| Primary Text | 👩 Sarah aus dem Mühlviertel ist dabei!<br><br>UNSERE ENERGIE REGIOS<br><br>Mia san ned Deppad! 🌱 |
| CTA | Learn More |
| Website URL | `https://www.regios.at/buerger?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=sarah_images` |
...
| Field | Content |
|-------|---------|
| Images | Susanne testimonial images (1080x1080) |
| Primary Text | 👩‍💼 Susanne, Gemeindevertreterin ist dabei!<br><br>UNSERE ENERGIE REGIOS<br><br>Über 18 Gemeinden sind schon dabei! 🌱 |
| CTA | Learn More |
| Website URL | `https://www.regios.at/gemeinde?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=susanne_images` |
...
| Field | Content |
|-------|---------|
| Images | Christian testimonial images (1080x1080) |
| Primary Text | 🏦 Christian, Bankpartner ist dabei!<br><br>UNSERE ENERGIE REGIOS<br><br>Banken als Entwicklungspartner! 🌱 |
| CTA | Learn More |
| Website URL | `https://www.regios.at/bank?utm_source=facebook&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=christian_images` |
...
| Field | Content |
|-------|---------|
| Images | Klaus testimonial images (1080x1080) |
...
|-------|---------|
| Images | Sarah testimonial images (1080x1080) |
| Caption | 👩 Sarah aus dem Mühlviertel ist dabei!<br><br>UNSERE ENERGIE REGIOS 🌱<br><br>#regios #mühlviertel #testimonial #energiegenossenschaft #miasanneddeppad |
| CTA | Learn More |
| Website URL | `https://www.regios.at/buerger?utm_source=instagram&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=sarah_images` |
...
|-------|---------|
| Images | Susanne testimonial images (1080x1080) |
| Caption | 👩‍💼 Susanne, Gemeindevertreterin ist dabei!<br><br>UNSERE ENERGIE REGIOS 🌱<br><br>#regios #mühlviertel #gemeinde #energiegenossenschaft #miasanneddeppad |
| CTA | Learn More |
| Website URL | `https://www.regios.at/gemeinde?utm_source=instagram&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=susanne_images` |
...
|-------|---------|
| Images | Christian testimonial images (1080x1080) |
| Caption | 🏦 Christian, Bankpartner ist dabei!<br><br>UNSERE ENERGIE REGIOS 🌱<br><br>#regios #mühlviertel #bank #energiegenossenschaft #miasanneddeppad |
| CTA | Learn More |
| Website URL | `https://www.regios.at/bank?utm_source=instagram&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=christian_images` |
...
|-------|---------|
| Images | Klaus testimonial images (1080x1080) |
| Caption | 👨‍💼 Klaus, Unternehmer ist dabei!<br><br>UNSERE ENERGIE REGIOS 🌱<br><br>#regios #mühlviertel #unternehmer #energiegenossenschaft #miasanneddeppad |
| CTA | Learn More |
| Website URL | `https://www.regios.at/unternehmer?utm_source=instagram&utm_medium=retargeting&utm_campaign=genossenschaft_bofu_retargeting&utm_content=klaus_images` |
...
However, YouTube retargeting requires Google Ads integration and a linked YouTube channel with sufficient viewer data.

**Recommendation:** Once the Meta retargeting campaigns are running and collecting data, consider expanding to YouTube retargeting with the long-form testimonial videos.
